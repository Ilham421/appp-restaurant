    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Original fast food from Indonesian 😋</h3>
                <p>Kami Menjamin Menggunakan Makanan Segar Dengan Kualitas Terbaik. Pelanggan Akan Menikmati Masakan Dengan Cita Rasa Yang Eksplosif dan Canggih.</p>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/b.webp" alt="" class="home-img">
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/promosi/promosi-1.webp" alt="">
                <h3>promosi</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/happymeal/happymeal-2.webp" alt="">
                <h3>happy meal</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/family/family-3.webp" alt="">
                <h3>family</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/dessert/dessert-1.webp" alt="">
                <h3>dessert</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/cocacola.webp" alt="">
                <h3>drink</h3>
            </router-link>
        </div>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/dis-1.webp" alt="">
                    <div class="content">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/dis-3.webp" alt="">
                    <div class="content">
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p>Makanan Untuk Pelanggan Selalu Terjamin Dengan Kualitas Terbaik. Menjanjikan Akan Menghadirkan Cita Rasa yang Eksplosif, Halus, dan Mengesankan. Layanan Pengiriman Kami Sangat Profesional, Pelanggan Dapat Menikmati Kualitas Yang Sama Di Restoran</p>
