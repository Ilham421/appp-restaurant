    ...
    <div class="promotions">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="activity-time">Discount 20% Happy Meal & Dessert </div>
                            </td>
                            <td class="bg-light-gray">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="bg-green activity-name">Happy Dinner & Family</span>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>party family up to 50% off</h3>
                <ul>
                    <li>
                        <p>Pesan Lebih Dari 10 Menu Family Akan Mendapatkan Diskon 50%%</p>
                    </li>
                    <li>
                        <p>Hanya Malam Hari Pekan</p>
                    </li>
                    <li>
                        <p>Metode Pembayaran Hanya Online</p>
                    </li>
                </ul>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                ...
                <ul>
                    <li>
                        <p>Gratis Ice Cream</p>
                    </li>
                    <li>
                        <p>Hanya makan siang dari jam 10 pagi sampai jam 2 siang</p>
                    </li>
                    <li>
                        <p>Only delivery</p>
                    </li>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>New menu 100% Cashback</h3>
                <ul>
                    <li>
                        <p>Gratis 1 McFlurry jika total belanja Rp. 50.000</p>
                    </li>
                    <li>
                        <p>Berlaku hingga 16-20 Desember 2022</p>
                    </li>
                    <li>
                        <p>Metode Pembayaran Hanya Online</p>
                    </li>
