            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">Anda tidak memiliki barang di keranjang Anda. Pergi berbelanja sekarang!</h2>
                                    </div>
                                    <div class="image">
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Lanjut Belanja</router-link>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +62 123 123 123</h3>
                                <span class="small">
