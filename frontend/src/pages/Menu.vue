                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="rtfPrice" class="d-flex justify-content-between">Rp 10000 - Rp 30000 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="5,10" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">Rp 30000 - Rp 60000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="10,12" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rp 60000 - Rp 100000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="mtPrice" value="12" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="mtPrice" class="d-flex justify-content-between">{{ ">" }} Rp 100000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="ltPrice" value="2" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="ltPrice" class="d-flex justify-content-between">{{ "<" }} Rp 50000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="promosiFilterFoodBtn" name="promosiFilterFoodBtn" class="menu-tab-item"
                            value="promosi" @click="filterFoodBtn($event)" />
                        <input type="button" id="happymealFilterFoodBtn" name="happymealFilterFoodBtn" class="menu-tab-item"
                            value="happy meal" @click="filterFoodBtn($event)" />
                        <input type="button" id="familyFilterFoodBtn" name="familyFilterFoodBtn" class="menu-tab-item"
                            value="family" @click="filterFoodBtn($event)" />
